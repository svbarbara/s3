...
export function RemoteSectionWithGlobe() {
  ...
  return (
    <section id="remote-globe" className="min-h-screen flex items-center py-16 bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900" dir={dir}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            {features.map((feature, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="group"
                >
                  <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-unified border border-slate-200 dark:border-slate-700 group-hover:-translate-y-2 h-full flex flex-col">
          ...
          <div className="flex justify-center lg:justify-end">
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative flex size-full max-w-lg items-center justify-center overflow-hidden h-[600px]"
            >
