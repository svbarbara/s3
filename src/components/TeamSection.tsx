...
const officeImage = new URL('../assets/hero-business.jpg', import.meta.url).href;
...
export function TeamSection() {
  ...
  return (
    <section id="team" className="min-h-screen flex items-center py-16 bg-gradient-to-br from-slate-50 via-white to-slate-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900" dir={dir}>
